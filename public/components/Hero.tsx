...
const Hero = () => {
  return (
    <section className="relative w-full h-screen mx-auto">
      <div className="sm:px-15 px-6 absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5">
